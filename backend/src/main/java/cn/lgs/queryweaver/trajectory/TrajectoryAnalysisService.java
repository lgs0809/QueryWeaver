...
import cn.lgs.queryweaver.evolution.MultiSourcePolicyPatch;
...
import cn.lgs.queryweaver.learning.QueryPatternTemplateService.CaptureMode;
import cn.lgs.queryweaver.evolution.MultiSourcePolicyPatch.PolicyAssetType;
import cn.lgs.queryweaver.evolution.MultiSourcePolicyPatchService;
import cn.lgs.queryweaver.multisource.MultiSourcePolicyService;
import cn.lgs.queryweaver.run.ExecutionSnapshot;
...
public class TrajectoryAnalysisService {
	...
	@Value("${queryweaver.trajectory.minimum-episodes:3}")
	private int minimumEpisodes;

	@Value("${queryweaver.trajectory.minimum-recurrence-rate:0.60}")
	private double minimumRecurrenceRate;

	@Value("${queryweaver.trajectory.high-confidence-episodes:5}")
	private int highConfidenceEpisodes;

	@Value("${queryweaver.trajectory.high-confidence-rate:0.80}")
