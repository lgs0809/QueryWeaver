...
import cn.lgs.queryweaver.semantic.application.SemanticMaterialIngestionService;
...
@RestController
@RequestMapping("/api/queryweaver/projects/{projectId}/versions/{versionId}/semantic-materials")
