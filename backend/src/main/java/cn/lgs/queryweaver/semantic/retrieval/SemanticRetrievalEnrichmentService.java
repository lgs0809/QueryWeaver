...
public class SemanticRetrievalEnrichmentService {
	...
	private static final String SYSTEM_PROMPT = """
			You create search-only natural-language retrieval enrichment for QueryWeaver.
			...
			formulas. Use only the allowed formal asset references supplied by QueryWeaver.
