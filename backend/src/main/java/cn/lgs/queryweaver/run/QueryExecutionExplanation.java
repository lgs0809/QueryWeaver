...
/** Deterministic, user-visible execution facts. This is not model chain-of-thought. */
public record QueryExecutionExplanation(String understoodQuery, List<Map<String, Object>> semanticBindings,
