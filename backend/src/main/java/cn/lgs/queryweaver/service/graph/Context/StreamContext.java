...
public class StreamContext {
	...
	/** QueryWeaver semantic project pinned when this stream starts. */
	private Long projectId;

	/** QueryWeaver semantic project version pinned when this stream starts. */
	private Long projectVersionId;

	/** Immutable catalog fingerprint pinned together with the project version. */
	...
	private final StringBuilder sqlCollector = new StringBuilder();

	public void appendOutput(String chunk) {
		outputCollector.append(chunk);
	}

	public void appendSql(String nodeName, String chunk) {
		if ("SqlGenerateNode".equals(nodeName)) {
	...
	public String getCollectedSql() {
		return sqlCollector.toString();
	}
