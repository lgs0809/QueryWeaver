 ...
 */
package cn.lgs.queryweaver.converter;
...
public class ModelConfigConverter {
	...
	public static ModelConfigDTO toDTO(ModelConfig entity) {
		...
		return ModelConfigDTO.builder()
			...
			.apiKeyConfigured(entity.getApiKey() != null && !entity.getApiKey().isBlank())
			...
			.proxyPasswordConfigured(entity.getProxyPassword() != null && !entity.getProxyPassword().isBlank())
			.validationStatus(entity.getValidationStatus())
			.lastValidationTime(entity.getLastValidationTime())
			.build();
	}
