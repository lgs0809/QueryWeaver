...
public class ReportTemplateUtil {
	...
	public ReportTemplateUtil(QueryWeaverProperties queryWeaverProperties) {
		this.queryWeaverProperties = queryWeaverProperties;
	}
	...
	public String getHeader() {
		// 执行替换
		return REPORT_TEMPLATE_HEADER.replace("{{MARKED_URL}}", queryWeaverProperties.getReportTemplate().getMarkedUrl())
			.replace("{{ECHARTS_URL}}", queryWeaverProperties.getReportTemplate().getEchartsUrl());
	}
