...
import static cn.lgs.queryweaver.constant.Constant.DB_DIALECT_TYPE;
import static cn.lgs.queryweaver.constant.Constant.EVIDENCE;
...
import static cn.lgs.queryweaver.constant.Constant.SQL_GENERATE_SCHEMA_MISSING_ADVICE;
import static cn.lgs.queryweaver.constant.Constant.TABLE_DOCUMENTS_FOR_SCHEMA_OUTPUT;
import static cn.lgs.queryweaver.constant.Constant.TABLE_RELATION_EXCEPTION_OUTPUT;
import static cn.lgs.queryweaver.constant.Constant.TABLE_RELATION_OUTPUT;
import static cn.lgs.queryweaver.constant.Constant.TABLE_RELATION_RETRY_COUNT;
...
import cn.lgs.queryweaver.service.schema.SchemaService;
...
/**
 * Builds the executable schema and semantic prompt from the pinned QueryWeaver catalog.
