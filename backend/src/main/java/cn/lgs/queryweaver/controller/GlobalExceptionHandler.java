...
import cn.lgs.queryweaver.exception.DatasourceConflictException;
import cn.lgs.queryweaver.exception.DatasourceConnectionException;
import cn.lgs.queryweaver.exception.DatasourceNotFoundException;
import cn.lgs.queryweaver.exception.InternalServerException;
import cn.lgs.queryweaver.exception.InvalidInputException;
import cn.lgs.queryweaver.exception.LogicalRelationConflictException;
import cn.lgs.queryweaver.exception.LogicalRelationNotFoundException;
...
import cn.lgs.queryweaver.evolution.MultiSourcePolicyPatchService.InvalidMultiSourcePolicyPatchException;
import cn.lgs.queryweaver.evolution.SemanticPatchValidator.SemanticPatchValidationException;
...
import cn.lgs.queryweaver.vo.ApiErrorCode;
...
public class GlobalExceptionHandler {
	...
	@Autowired
	public GlobalExceptionHandler(QueryWeaverMetrics metrics) {
		this.metrics = metrics;
	}

	public GlobalExceptionHandler() {
		this(QueryWeaverMetrics.noop());
	}
	...
	public ApiResponse<Object> handleProjectNotReady(ProjectNotReadyException e) {
		log.info("QueryWeaver project is not ready: {}", e.getMessage());
	...
	public ApiResponse<Object> handleSecurityException(SecurityException e) {
		log.warn("Forbidden QueryWeaver operation: {}", e.getMessage());
		return ApiResponse.error(ApiErrorCode.FORBIDDEN, e.getMessage());
	}
	...
	public ApiResponse<Object> handleIllegalState(IllegalStateException e) {
		return ApiResponse.error(ApiErrorCode.INVALID_STATE, e.getMessage());
	}
	...
	public ApiResponse<Object> handleIllegalArgument(IllegalArgumentException e) {
		return ApiResponse.error(ApiErrorCode.INVALID_ARGUMENT, e.getMessage());
	}
