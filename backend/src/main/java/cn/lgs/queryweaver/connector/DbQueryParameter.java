...
public class DbQueryParameter {
	...
	public DbQueryParameter setParameters(List<Object> parameters) {
	...
	public DbQueryParameter setCancellationKey(String cancellationKey) {
