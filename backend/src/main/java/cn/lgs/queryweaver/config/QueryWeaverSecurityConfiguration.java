...
import cn.lgs.queryweaver.common.QueryWeaverSecurityProperties;
...
@EnableConfigurationProperties(QueryWeaverSecurityProperties.class)
public class QueryWeaverSecurityConfiguration {

	private static final String ADMIN = "ROLE_QUERYWEAVER_ADMIN";

	private static final String[] WRITE_AUTHORITIES = { "ROLE_QUERYWEAVER_EDITOR", "ROLE_QUERYWEAVER_REVIEWER",
			"ROLE_QUERYWEAVER_PUBLISHER", ADMIN };

	private static final String[] RUNTIME_AUTHORITIES = { "ROLE_QUERYWEAVER_VIEWER", "ROLE_QUERYWEAVER_EDITOR",
			"ROLE_QUERYWEAVER_REVIEWER", "ROLE_QUERYWEAVER_PUBLISHER", ADMIN };
	...
	@Bean
	@Order(1)
	SecurityWebFilterChain queryWeaverSecurityWebFilterChain(ServerHttpSecurity http,
			QueryWeaverSecurityProperties properties) {
		...
		return http
			.authorizeExchange(exchange -> exchange.pathMatchers("/actuator/health/**")
				...
				.hasAuthority(ADMIN)
				.pathMatchers(HttpMethod.POST, "/api/queryweaver/projects/*/conversations",
						"/api/queryweaver/projects/*/conversations/*/messages",
						"/api/queryweaver/projects/*/conversations/*/runs/*/human-review",
						"/api/queryweaver/projects/*/conversations/*/runs/*/sync",
						"/api/queryweaver/projects/*/conversations/*/runs/*/corrections/binding",
						"/api/queryweaver/runs/*/cancel", "/api/queryweaver/runs/*/resume",
						"/api/queryweaver/runs/*/clarification/*/answer",
						"/api/queryweaver/operations/episodes/*/feedback")
	...
	private Collection<GrantedAuthority> authorities(Jwt jwt, QueryWeaverSecurityProperties properties) {
