...
import cn.lgs.queryweaver.util.McpServerToolUtil;
import cn.lgs.queryweaver.util.NodeBeanUtil;
import cn.lgs.queryweaver.service.aimodelconfig.AiModelRegistry;
import cn.lgs.queryweaver.workflow.dispatcher.*;
import cn.lgs.queryweaver.workflow.node.*;
...
@EnableConfigurationProperties({ CodeExecutorProperties.class, ConversationContextProperties.class,
		QueryWeaverProperties.class, FileStorageProperties.class, ModelClientProperties.class })
public class QueryWeaverConfiguration {
