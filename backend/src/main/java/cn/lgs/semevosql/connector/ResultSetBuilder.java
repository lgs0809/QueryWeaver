...
public class ResultSetBuilder {
	...
	public static ResultSetBO buildFrom(ResultSet rs, String schema) throws SQLException {
		return buildFrom(rs, schema, SqlExecutor.DEFAULT_RESULT_SET_LIMIT);
	}

	public static ResultSetBO buildFrom(ResultSet rs, String schema, int maxRows) throws SQLException {
